...
bool USCJsonObject::DecodeJson(const FString& JsonString)
{
	...
	UE_LOG(SCJson, Error, TEXT("Json decoding failed for: %s"), *JsonString);
...
float USCJsonObject::GetNumberField(const FString& FieldName) const
{
	...
	{
		UE_LOG(SCJson, Warning, TEXT("No field with name %s of type Number"), *FieldName);
		return 0.0f;
	}
...
FString USCJsonObject::GetStringField(const FString& FieldName) const
{
	...
	{
		UE_LOG(SCJson, Warning, TEXT("No field with name %s of type String"), *FieldName);
		return TEXT("");
	}
...
bool USCJsonObject::GetBoolField(const FString& FieldName) const
{
	...
	{
		UE_LOG(SCJson, Warning, TEXT("No field with name %s of type Boolean"), *FieldName);
		return false;
	}
...
TArray<USCJsonValue*> USCJsonObject::GetArrayField(const FString& FieldName)
{
	...
	{
		UE_LOG(SCJson, Warning, TEXT("No field with name %s of type Array"), *FieldName);
	}
...
USCJsonObject* USCJsonObject::GetObjectField(const FString& FieldName) const
{
	...
	{
		UE_LOG(SCJson, Warning, TEXT("No field with name %s of type Object"), *FieldName);
		return nullptr;
	}
...
void USCJsonObject::GetBinaryField(const FString& FieldName, TArray<uint8>& OutBinary) const
{
	...
	else if (JsonValue->Type == EJson::String)
	{
		...
		{
			UE_LOG(SCJson, Warning, TEXT("USCJsonObject::GetBinaryField couldn't decode %s as a binary."), *JsonValue->AsString());
		}
...
TArray<float> USCJsonObject::GetNumberArrayField(const FString& FieldName)
{
	...
	for (TArray<TSharedPtr<FJsonValue> >::TConstIterator It(JsonArrayValues); It; ++It)
	{
		...
		{
			UE_LOG(SCJson, Error, TEXT("Not Number element in array with field name %s"), *FieldName);
		}
...
TArray<FString> USCJsonObject::GetStringArrayField(const FString& FieldName)
{
	...
	for (TArray<TSharedPtr<FJsonValue> >::TConstIterator It(JsonArrayValues); It; ++It)
	{
		...
		{
			UE_LOG(SCJson, Error, TEXT("Not String element in array with field name %s"), *FieldName);
		}
...
TArray<bool> USCJsonObject::GetBoolArrayField(const FString& FieldName)
{
	...
	for (TArray<TSharedPtr<FJsonValue> >::TConstIterator It(JsonArrayValues); It; ++It)
	{
		...
		{
			UE_LOG(SCJson, Error, TEXT("Not Boolean element in array with field name %s"), *FieldName);
		}
...
TArray<USCJsonObject*> USCJsonObject::GetObjectArrayField(const FString& FieldName)
{
	...
	for (auto Value : ValArray)
	{
		...
		{
			UE_LOG(SCJson, Error, TEXT("Not Object element in array with field name %s"), *FieldName);
		}

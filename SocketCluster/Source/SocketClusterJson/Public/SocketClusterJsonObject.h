...
#include "SocketClusterJsonObject.generated.h"

class USocketClusterJsonValue;
class FJsonObject;
...
class SOCKETCLUSTERJSON_API USocketClusterJsonObject : public UObject
{
	GENERATED_BODY()

public:

	USocketClusterJsonObject();
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Construct Json Object", HidePin = "WorldContextObject", DefaultToSelf = "WorldContextObject"), Category = "SocketCluster|Json")
		static USocketClusterJsonObject* ConstructJsonObject(UObject* WorldContextObject);
	...
	UFUNCTION(BlueprintCallable, Category = "SocketCluster|Json")
		USocketClusterJsonValue* GetField(const FString& FieldName) const;

	/** Add a field named FieldName with a Value */
	UFUNCTION(BlueprintCallable, Category = "SocketCluster|Json")
		void SetField(const FString& FieldName, USocketClusterJsonValue* JsonValue);

	/** Get the field named FieldName as a Json Array */
	UFUNCTION(BlueprintCallable, Category = "SocketCluster|Json")
		TArray<USocketClusterJsonValue*> GetArrayField(const FString& FieldName) const;

	/** Set an ObjectField named FieldName and value of Json Array */
	UFUNCTION(BlueprintCallable, Category = "SocketCluster|Json")
		void SetArrayField(const FString& FieldName, const TArray<USocketClusterJsonValue*>& InArray);

	/** Adds all of the fields from one json object to this one */
	UFUNCTION(BlueprintCallable, Category = "SocketCluster|Json")
		void MergeJsonObject(USocketClusterJsonObject* InJsonObject, bool Overwrite);
	...
	* Attn.!! float used instead of double to make the function blueprintable! */
	...
	UFUNCTION(BlueprintCallable, Category = "SocketCluster|Json")
		USocketClusterJsonObject* GetObjectField(const FString& FieldName) const;

	/** Set an ObjectField named FieldName and value of JsonObject */
	UFUNCTION(BlueprintCallable, Category = "SocketCluster|Json")
		void SetObjectField(const FString& FieldName, USocketClusterJsonObject* JsonObject);
	...
	* Attn.!! float used instead of double to make the function blueprintable! */
	...
	UFUNCTION(BlueprintCallable, Category = "SocketCluster|Json")
		TArray<USocketClusterJsonObject*> GetObjectArrayField(const FString& FieldName) const;

	/** Set an ObjectField named FieldName and value of Ob Array */
	UFUNCTION(BlueprintCallable, Category = "SocketCluster|Json")
		void SetObjectArrayField(const FString& FieldName, const TArray<USocketClusterJsonObject*>& ObjectArray);

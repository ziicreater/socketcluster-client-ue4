...
TSharedPtr<FJsonObject> USCJsonConvert::ToJsonObject(UStruct* Struct, void* StructPtr, bool IsBlueprintStruct)
{	
...
bool USCJsonConvert::JsonObjectToUStruct(TSharedPtr<FJsonObject> JsonObject, UStruct* Struct, void* StructPtr, bool IsBlueprintStruct)
{
	if (IsBlueprintStruct)
	{
...
void USCJsonConvert::SetTrimmedKeyMapForProp(TSharedPtr<FTrimmedKeyMap>& InMap, UProperty* InnerProperty)
{

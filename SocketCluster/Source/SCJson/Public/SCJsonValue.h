...
public:
	...
	* Attn.!! float used instead of double to make the function blueprintable! */
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Construct Json Object Value", HidePin = "WorldContextObject", DefaultToSelf = "WorldContextObject"), Category = "SocketCluster|Json")
		static USCJsonValue* ConstructJsonValueObject(UObject* WorldContextObject, USCJsonObject* JsonObject);

	/** Create new Json value from FJsonValue (to be used from SCJsonObject) */
